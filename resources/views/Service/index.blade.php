                        ...
                        <table class="table table-hover js-basic-example dataTable table-custom spacing8" id="m_table_1">
                            ...
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td>{{ $service->name }}</td>
                                    <td class="text-right">
                                        <a data-toggle="modal" data-id="{{ $service->id }}" data-target="#update" href="#" class="btn btn-primary updateType" id="{{$service->id}}">
                                            <i class='fa fa-edit'></i>
                                        </a>

                                        <a data-toggle="modal" data-id="{{ $service->id }}" data-target="#delete" href="#" class="btn btn-danger daleteType" id="{{$service->id}}">
...
<div class="modal fade confirmtion2" id="update" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Update Services Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input value="" type="text" class="form-control typeUpdateService"
                                           name="name" placeholder="Enter Services Type" >
...
<div class="modal fade confirmtion" id="add" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Add Services Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                $.ajax(
                    {
                        ...
                        {
                            if(  parseInt( document.querySelector('#m_table_1 >  tbody').childElementCount) -1 == 0 ){
