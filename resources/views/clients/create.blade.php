        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="POST" action="{{route('admin.client.store')}}" id="basic-form"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('companyName') }}" type="text"
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('companyField') }}" type="text"
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        <label for="company_number" class="control-label">Company Number  <span class="required">*</span></label>
                                        <input value="{{ old('companyNo') }}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="address" class="control-label">password  <span class="required">*</span></label>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <a class="btn btn-dark mb-3" href="{{ route('admin.client.create') }}">Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
